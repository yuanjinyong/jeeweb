...
@Service
@Transactional
public class ModelService extends ActivitiService<String, ModelEntity> {
    private static final Logger LOG = LoggerFactory.getLogger(ModelService.class);

    @Override
    protected BaseMapper<String, ModelEntity> getMapper() {
        return null;
    }

    @Override
    @Transactional(readOnly = true)
    public ModelEntity selectEntity(String primaryKey) {
        Model model = repositoryService.getModel(primaryKey);
        return buildModelEntity(model);
    }

    @Override
    @Transactional(readOnly = true)
    public List<ModelEntity> selectEntityListPage(ParameterMap params) {
        ...
        for (Model model : modelList) {
            entityList.add(buildModelEntity(model));
        }
    ...
    @Override
    public void insertEntity(ModelEntity entity) {
    ...
    @Override
    public void updateEntity(String primaryKey, ModelEntity entity) {
        Model model = buildModel(entity);
        repositoryService.saveModel(model);
    }
    ...
    private ModelEntity buildModelEntity(Model model) {
        return new ModelEntity((org.activiti.engine.impl.persistence.entity.ModelEntity) model);
    }

    private Model buildModel(ModelEntity entity) {
