...
INSERT INTO `t_sys_menu`(`f_id`,`f_parent_id`,`f_parent_path`,`f_order`,`f_name`,`f_desc`,`f_icon`,`f_type`,`f_route_path`,`f_is_web`,`f_is_android`,`f_is_ios`,`f_status`,`f_remark`) VALUES ('GZLGL','ROOT','/ROOT/',800,'工作流管理','工作流管理模块','fa fa-random',1,NULL,101,102,102,101,NULL);
...
INSERT INTO `t_sys_menu`(`f_id`,`f_parent_id`,`f_parent_path`,`f_order`,`f_name`,`f_desc`,`f_icon`,`f_type`,`f_route_path`,`f_is_web`,`f_is_android`,`f_is_ios`,`f_status`,`f_remark`) VALUES ('GZLGL-LCMXGL','GZLGL','/ROOT/GZLGL/',10,'流程模型管理','流程模型管理页面','fa fa-meetup',2,'/admin/activiti/process/model',101,102,102,101,NULL);
INSERT INTO `t_sys_menu`(`f_id`,`f_parent_id`,`f_parent_path`,`f_order`,`f_name`,`f_desc`,`f_icon`,`f_type`,`f_route_path`,`f_is_web`,`f_is_android`,`f_is_ios`,`f_status`,`f_remark`) VALUES ('GZLGL-LCMXGL-ZJ','GZLGL-LCMXGL','/ROOT/GZLGL/GZLGL-LCMXGL/',10,'增加','增加流程模型',NULL,3,NULL,101,102,102,101,NULL);
INSERT INTO `t_sys_menu`(`f_id`,`f_parent_id`,`f_parent_path`,`f_order`,`f_name`,`f_desc`,`f_icon`,`f_type`,`f_route_path`,`f_is_web`,`f_is_android`,`f_is_ios`,`f_status`,`f_remark`) VALUES ('GZLGL-LCMXGL-XG','GZLGL-LCMXGL','/ROOT/GZLGL/GZLGL-LCMXGL/',20,'修改','修改流程模型',NULL,3,NULL,101,102,102,101,NULL);
INSERT INTO `t_sys_menu`(`f_id`,`f_parent_id`,`f_parent_path`,`f_order`,`f_name`,`f_desc`,`f_icon`,`f_type`,`f_route_path`,`f_is_web`,`f_is_android`,`f_is_ios`,`f_status`,`f_remark`) VALUES ('GZLGL-LCMXGL-SC','GZLGL-LCMXGL','/ROOT/GZLGL/GZLGL-LCMXGL/',30,'删除','删除流程模型',NULL,3,NULL,101,102,102,101,NULL);
INSERT INTO `t_sys_menu`(`f_id`,`f_parent_id`,`f_parent_path`,`f_order`,`f_name`,`f_desc`,`f_icon`,`f_type`,`f_route_path`,`f_is_web`,`f_is_android`,`f_is_ios`,`f_status`,`f_remark`) VALUES ('GZLGL-LCMXGL-BJ','GZLGL-LCMXGL','/ROOT/GZLGL/GZLGL-LCMXGL/',40,'编辑','编辑流程节点',NULL,3,NULL,101,102,102,101,NULL);
INSERT INTO `t_sys_menu`(`f_id`,`f_parent_id`,`f_parent_path`,`f_order`,`f_name`,`f_desc`,`f_icon`,`f_type`,`f_route_path`,`f_is_web`,`f_is_android`,`f_is_ios`,`f_status`,`f_remark`) VALUES ('GZLGL-LCMXGL-FB','GZLGL-LCMXGL','/ROOT/GZLGL/GZLGL-LCMXGL/',50,'发布','发布流程模型',NULL,3,NULL,101,102,102,101,NULL);
INSERT INTO `t_sys_menu`(`f_id`,`f_parent_id`,`f_parent_path`,`f_order`,`f_name`,`f_desc`,`f_icon`,`f_type`,`f_route_path`,`f_is_web`,`f_is_android`,`f_is_ios`,`f_status`,`f_remark`) VALUES ('GZLGL-LCMXGL-XZ','GZLGL-LCMXGL','/ROOT/GZLGL/GZLGL-LCMXGL/',60,'下载','下载流程模型',NULL,3,NULL,101,101,101,101,NULL);
