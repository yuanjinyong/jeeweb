...
CREATE TABLE `t_sys_setting` (
  ...
  `f_is_editable` tinyint(3) unsigned NOT NULL DEFAULT '101' COMMENT '是否开放给客户编辑：101、是；102、否',
...
-- changeset 袁进勇:20170502000102
-- comment: 预置系统设置（参数）项
/*Data for the table `t_sys_setting` */
insert into `t_sys_setting` (`f_id`, `f_code`, `f_name`, `f_desc`, `f_order`, `f_is_editable`, `f_field_type`, `f_field_cfg`, `f_init_value`, `f_value`, `f_remark`) values('1','ZKPMS.MASTER.COMPANY.REGISTER.AUDIT','企业注册是否需要审核','101、是；102、否。','1','101','String',NULL,'101','102','为了方便推广，现在企业注册暂时设置为不需要审核。');
