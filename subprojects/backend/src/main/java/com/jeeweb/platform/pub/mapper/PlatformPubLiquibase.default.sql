...
insert into `t_sys_setting` (`f_code`, `f_name`, `f_desc`, `f_order`, `f_is_editable`, `f_field_type`, `f_field_cfg`, `f_init_value`, `f_value`, `f_remark`) values('PLATFORM.PUB.ATTACHMENT.DIRECTORY','附件本地存储目录',NULL,'2','101','String',NULL,'/home/ci/attachment','/home/ci/attachment',NULL);
...
insert into `t_sys_menu`(`f_id`,`f_parent_id`,`f_parent_path`,`f_order`,`f_name`,`f_desc`,`f_icon`,`f_type`,`f_route_path`,`f_is_web`,`f_is_android`,`f_is_ios`,`f_status`,`f_remark`) values ('KFGJ-FJGL','KFGJ','/ROOT/KFGJ/',110,'附件管理','附件管理',NULL,2,'/admin/platform/pub/attachment',101,101,101,101,NULL);
