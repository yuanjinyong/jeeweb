...
DELETE FROM `t_sys_role` WHERE f_is_preset = 101;

INSERT INTO `t_sys_role`(`f_id`,`f_name`,`f_desc`,`f_is_preset`,`f_remark`) VALUES (1,'系统管理员角色','用于系统的运营维护。',101,'系统主要分为平台运维、施工企业、业主监督等子系统。');
INSERT INTO `t_sys_role`(`f_id`,`f_name`,`f_desc`,`f_is_preset`,`f_remark`) VALUES (2,'普通用户角色',NULL,101,NULL);
INSERT INTO `t_sys_role`(`f_id`,`f_name`,`f_desc`,`f_is_preset`,`f_remark`) VALUES (3,'平台管理员角色','用于平台的运营维护。',101,'注意：不能分配企业相关的功能给该角色。');
INSERT INTO `t_sys_role`(`f_id`,`f_name`,`f_desc`,`f_is_preset`,`f_remark`) VALUES (4,'企业管理员角色','用于企业的运营维护，主要为企业的权限分配。',101,'注意：不能分配平台相关的功能给该角色。');
