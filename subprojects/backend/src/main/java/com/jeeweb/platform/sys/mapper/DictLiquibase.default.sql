...
DELETE FROM t_sys_dict_item WHERE f_dict_code = 'YesNo0';
DELETE FROM t_sys_dict WHERE f_code = 'YesNo0';
...
DELETE FROM t_sys_dict_item WHERE f_dict_code = 'YesNo2';
DELETE FROM t_sys_dict WHERE f_code = 'YesNo2';
