...
public class InformationSchemaService {
    ...
    public List<Map<String, Object>> selectSchemataListPage(ParameterMap params) {
        SqlBuilder sql = new SqlBuilder(params, "SELECT * FROM information_schema.SCHEMATA WHERE 1=1 \n");
    ...
    public List<Map<String, Object>> selectTableListPage(ParameterMap params) {
        SqlBuilder sql = new SqlBuilder(params, "SELECT * FROM information_schema.TABLES WHERE 1=1 \n");
    ...
    public List<Map<String, Object>> selectColumnListPage(ParameterMap params) {
        SqlBuilder sql = new SqlBuilder(params, "SELECT * FROM information_schema.COLUMNS WHERE 1=1 \n");
