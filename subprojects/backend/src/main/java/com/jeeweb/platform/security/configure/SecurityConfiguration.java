 ...
 * 
 */
package com.jeeweb.platform.security.configure;
...
import com.jeeweb.platform.security.web.filter.RestAccessDecisionManager;
import com.jeeweb.platform.security.web.filter.RestSecurityFilter;
import com.jeeweb.platform.security.web.filter.RestSecurityMetadataSource;
import com.jeeweb.platform.security.web.filter.RestTokenProcessingFilter;
import com.jeeweb.platform.security.web.handler.AuthorizationSuccessHandler;
import com.jeeweb.platform.security.web.handler.RestAccessDeniedHandler;
import com.jeeweb.platform.security.web.handler.RestAuthenticationEntryPoint;
import com.jeeweb.platform.security.web.handler.RestLogoutSuccessHandler;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private List<AuthorizationSuccessHandler> authorizationSuccessHandlers;
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.addExposedHeader(RestTokenCacheService.REST_TOKEN);
    ...
    public RestSecurityFilter restSecurityFilter() throws Exception {
        ...
        filter.addAuthorizationSuccessHandlers(authorizationSuccessHandlers);
